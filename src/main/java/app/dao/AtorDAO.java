...
public interface AtorDAO extends JpaRepository<Ator, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.filme FROM Atuacao entity WHERE entity.ator.id = :id")
   ...
   */
  @Modifying
  @Query("DELETE FROM Atuacao entity WHERE entity.ator.id = :instanceId AND entity.filme.id = :relationId")
